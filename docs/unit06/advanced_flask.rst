...
.. code-block:: console
   ...
   [coe332-vm]$ curl localhost:5000/degrees -v
...
.. code-block:: console
   ...
   [coe332-vm]$ curl http://127.0.0.1:5000/degrees?start=abc
...
.. code-block:: console
   ...
   [coe332-vm]$ curl http://127.0.0.1:5000/degrees
   -or-
   [coe332-vm]$ curl -X GET http://127.0.0.1:5000/degrees
...
.. code-block:: console
   ...
   [coe332-vm]$ curl -X DELETE http://127.0.0.1:5000/degrees \
